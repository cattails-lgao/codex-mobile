// Codex auth.json + free-mode on-disk state slice, extracted from
// createCodexBridgeMiddleware. Covers reading/refreshing the ChatGPT auth at
// ~/.codex/auth.json and canonicalizing the free-mode state file via TOML
// model-provider probing. Pure module-level helpers with zero shell closures;
// the shell imports the helpers/types and re-exports the public ones its tests
// (authRefresh / archive) consume.
