...
function onDocumentPointerDown(event: PointerEvent): void {
  ...
  if (settingsDialogRef.value?.containsTarget(target)) return
...
const settingsDialogProps = computed(() => ({
  activeSettingsGroup: activeSettingsGroup.value,
  accounts: accounts.value,
  isAccountsSectionCollapsed: isAccountsSectionCollapsed.value,
  isRefreshingAccounts: isRefreshingAccounts.value,
  isSwitchingAccounts: isSwitchingAccounts.value,
  isStartingCodexLogin: isStartingCodexLogin.value,
  isCompletingCodexLogin: isCompletingCodexLogin.value,
  accountActionError: accountActionError.value,
  codexLoginUrl: codexLoginUrl.value,
  feedbackMailto,
  ...
  toggleAccountsSectionCollapsed,
  prepareFeedbackLink,
  sendWithEnter: sendWithEnter.value,
  inProgressSendMode: inProgressSendMode.value,
  darkMode: darkMode.value,
  uiLanguage: uiLanguage.value,
  uiLanguageOptions,
  chatWidthLabel: chatWidthLabel.value,
  dictationClickToToggle: dictationClickToToggle.value,
  dictationAutoSend: dictationAutoSend.value,
  dictationLanguage: dictationLanguage.value,
  dictationLanguageOptions: dictationLanguageOptions.value,
  autoCompactThreshold: autoCompactThreshold.value,
  autoCompactThresholdOptions,
  hasVisibleFeedbackError: hasVisibleFeedbackError.value,
  selectedProvider: selectedProvider.value,
  providerDropdownOptions: providerDropdownOptions.value,
  freeModeLoading: freeModeLoading.value,
  providerError: providerError.value,
  freeModeHasCustomKey: freeModeHasCustomKey.value,
  freeModeCustomKey: freeModeCustomKey.value,
  freeModeCustomKeyMasked: freeModeCustomKeyMasked.value,
  freeModeCustomKeySaving: freeModeCustomKeySaving.value,
  openRouterWireApi: openRouterWireApi.value,
  opencodeZenKey: opencodeZenKey.value,
  customEndpointUrl: customEndpointUrl.value,
  customEndpointKey: customEndpointKey.value,
  customEndpointWireApi: customEndpointWireApi.value,
  isTelegramConfigOpen: isTelegramConfigOpen.value,
  telegramStatusText: telegramStatusText.value,
  telegramBotTokenDraft: telegramBotTokenDraft.value,
  telegramAllowedUserIdsDraft: telegramAllowedUserIdsDraft.value,
  telegramConfigError: telegramConfigError.value,
  isTelegramSaving: isTelegramSaving.value,
  supportsHooks: supportsHooks.value,
  isHooksLoading: isHooksLoading.value,
  hooksList: hooksList.value,
  supportsRemoteControl: supportsRemoteControl.value,
  remoteControlStatus: remoteControlStatus.value,
  isRemoteControlActionInFlight: isRemoteControlActionInFlight.value,
  remoteControlError: remoteControlError.value,
  remoteControlNotice: remoteControlNotice.value,
  isRemoteControlLoading: isRemoteControlLoading.value,
  remoteControlActionName: remoteControlActionName.value,
  pairingCode: pairingCode.value,
  accountRateLimitSnapshots: accountRateLimitSnapshots.value,
  worktreeName,
  appVersion,
  onClose: () => { isSettingsOpen.value = false },
  onActiveSettingsGroupChange: (group: 'general' | 'models' | 'integrations' | 'usage') => { activeSettingsGroup.value = group },
  toggleSendWithEnter,
  ...
  onProviderChange,
  onFreeModeCustomKeyChange: (key: string) => { freeModeCustomKey.value = key },
  clearFreeModeCustomKey,
  saveFreeModeCustomKey,
  setOpenRouterWireApi,
  onOpencodeZenKeyChange: (key: string) => { opencodeZenKey.value = key },
  saveOpencodeZen,
  onCustomEndpointUrlChange: (url: string) => { customEndpointUrl.value = url },
  onCustomEndpointKeyChange: (key: string) => { customEndpointKey.value = key },
  saveCustomEndpoint,
  onCustomEndpointWireApiChange: (wireApi: 'responses' | 'chat') => { customEndpointWireApi.value = wireApi },
  onTelegramConfigOpenChange: (open: boolean) => { isTelegramConfigOpen.value = open },
  onTelegramBotTokenDraftChange: (token: string) => { telegramBotTokenDraft.value = token },
  onTelegramAllowedUserIdsDraftChange: (ids: string) => { telegramAllowedUserIdsDraft.value = ids },
  saveTelegramConfig,
  refreshHooks,
  toggleRemoteControl,
  startRemotePairing,
