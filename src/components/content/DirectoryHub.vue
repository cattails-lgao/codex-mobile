<template>
  <div class="directory-hub">
    ...
    <DirectorySkillsTab
      ...
      :supports-mcps="supportsMcps"
      :mcp-error="mcpError"
      :is-loading-mcps="isLoadingMcps"
      :visible-mcp-servers="visibleMcpServers"
      :is-mcp-section-open="isMcpSectionOpen"
      :expanded-mcp-names="expandedMcpNames"
      :format-mcp-auth-status="formatMcpAuthStatus"
      :mcp-card-badge-class="mcpCardBadgeClass"
      :toggle-mcp-section-open="() => { isMcpSectionOpen = !isMcpSectionOpen }"
      :toggle-mcp-expanded="toggleMcpExpanded"
