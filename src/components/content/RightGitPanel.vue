...
:global(:root.dark) .rgp-review {
  @apply border-zinc-700 bg-zinc-800 text-zinc-100 hover:bg-zinc-700;
}

:global(:root.dark) .rgp-state,
:global(:root.dark) .rgp-section {
  @apply border-zinc-700 bg-zinc-800;
}

:global(:root.dark) .rgp-state-label {
  @apply text-zinc-400;
}

:global(:root.dark) .rgp-state-value,
:global(:root.dark) .rgp-commit-detail-subject,
:global(:root.dark) .rgp-branch-button,
:global(:root.dark) .rgp-commit,
:global(:root.dark) .rgp-file {
  @apply text-zinc-200;
}

:global(:root.dark) .rgp-branch-button:hover,
:global(:root.dark) .rgp-commit:hover,
:global(:root.dark) .rgp-file:hover {
  @apply bg-zinc-700;
}

:global(:root.dark) .rgp-branch-button.is-current,
:global(:root.dark) .rgp-branch-button.is-selected,
:global(:root.dark) .rgp-commit.is-current,
:global(:root.dark) .rgp-commit.is-selected {
  @apply bg-zinc-700 text-zinc-100;
}

:global(:root.dark) .rgp-branch-meta {
  @apply bg-zinc-600 text-zinc-300;
}

:global(:root.dark) .rgp-ref {
  @apply bg-zinc-600 text-zinc-200;
}

:global(:root.dark) .rgp-search {
  @apply border-zinc-700 bg-zinc-900 text-zinc-100;
}

:global(:root.dark) .rgp-file-status {
  @apply bg-zinc-600 text-zinc-300;
}

:global(:root.dark) .rgp-section-title,
:global(:root.dark) .rgp-empty,
