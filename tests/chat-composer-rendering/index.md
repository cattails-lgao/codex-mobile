...
| [No empty processFold blocks during a turn](no-empty-processfold-block-during-turn.md) |
| [No empty generic process rows during a turn](no-empty-generic-process-row-during-turn.md) |
