...
| [Thread Loading, Streaming, and State](tests/thread-loading-state/index.md) | 31 | Thread list/detail loading, pagination, selected-thread stability, streaming scroll behavior, live-state reads, missing-thread handling, and reasoning placement. |
