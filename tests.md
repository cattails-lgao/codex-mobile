...
| [Theme, Layout, and Terminal](tests/theme-layout-terminal/index.md) | 19 | Light/dark theme regressions, responsive layout, terminal UI, mobile keyboard behavior, dialog sizing, and visual alignment. |
