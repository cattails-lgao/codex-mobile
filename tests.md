...
| [Thread Loading, Streaming, and State](tests/thread-loading-state/index.md) | 34 | Thread list/detail loading, pagination, selected-thread stability, streaming scroll behavior, live-state reads, missing-thread handling, reasoning placement, and payload slimming/command-output spill. |
