...
| [Theme, Layout, and Terminal](tests/theme-layout-terminal/index.md) | 29 | Light/dark theme regressions, design-token coverage, responsive layout, terminal UI, mobile keyboard behavior, dialog sizing, and visual alignment. |
