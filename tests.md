...
| [Chat Composer and Message Rendering](tests/chat-composer-rendering/index.md) | 39 | Composer controls, queued messages, plan mode, markdown parsing, file links, attachments, generated images, and visible message rows. |
...
| [Theme, Layout, and Terminal](tests/theme-layout-terminal/index.md) | 22 | Light/dark theme regressions, responsive layout, terminal UI, mobile keyboard behavior, dialog sizing, and visual alignment. |
