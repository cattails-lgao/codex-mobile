...
- **发布已完成**：版本 `0.1.103`，代码与 git tag `v0.1.103` 已推送到 `origin`（tag → 版本/文档提交 `d9f5972`），`pnpm run build` 通过（web + CLI 均成功）。**GitHub release `v0.1.103`** 见 https://github.com/cattails-lgao/codex-mobile/releases/tag/v0.1.103（2026-08-22 用 `gh release create` 创建，非草稿/非预发布，指向 main）；**npm 发包已完成**：`codex-mobile-re@0.1.103` 成为 `latest`（`npm view codex-mobile-re@0.1.103` 确认）。