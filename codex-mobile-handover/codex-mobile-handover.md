...
| 最近提交 | round-43 release 随 v0.1.96（`ff6df2b` 侧边栏泄漏子 agent 线程——`externalSessionTracker` subagent 用自身 id 键控；`5aaa458` 模型强度下拉收敛到 Low/Medium/High；`64fa15d` 版本 0.1.96），GitHub release `v0.1.96` 已创建，npm 发包待手动 `npm login` 后执行 |
