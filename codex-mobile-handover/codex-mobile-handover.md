...
| 最近提交 | e192351（遗留项补齐：composer popover 键盘导航 + 需求 9 中断消息回填提示，已提交） |
...
- **验收遗留**：plan/approval popover 键盘导航已补齐（见「遗留项补齐（2026-08-07）」）；ExecPlans 待后端 Codex 版本支持后自动变为可选；macOS 侧跨平台回归尚未验证
