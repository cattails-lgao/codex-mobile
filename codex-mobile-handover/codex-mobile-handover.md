...
| 最近提交 | round-43 修复（侧边栏泄漏子 agent 线程——`externalSessionTracker` subagent 用自身 id 键控，待提交），上轮 6378b34（round-41/42 修复：自定义端点 URL 归一化与模型列表、回退回填、codex 模型对齐 codex-cli；随 v0.1.95 发布） |
...
| 第三十七轮 1 项（侧边栏泄漏子 agent 线程——subagent rollout 用自身 id 键控） | [rounds/round-43-feedback.md](rounds/round-43-feedback.md) |
